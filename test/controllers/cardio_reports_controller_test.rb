...
class CardioReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cardio_report" do
    assert_difference('CardioReport.count') do
      post cardio_reports_url, params: { cardio_report: { cardio_type: @cardio_report.cardio_type, machine: @cardio_report.machine, miles: @cardio_report.miles, duration: @cardio_report.duration, finished_at: @cardio_report.finished_at } }
    end
  ...
  test "should update cardio_report" do
    patch cardio_report_url(@cardio_report), params: { cardio_report: { cardio_type: @cardio_report.cardio_type, machine: @cardio_report.machine, miles: @cardio_report.miles, duration: @cardio_report.duration, finished_at: @cardio_report.finished_at } }
