...
class CardioReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cardio_report" do
    assert_difference('CardioReport.count') do
      post cardio_reports_url, params: { cardio_report: { cardio_type: @cardio_report.cardio_type, machine: @cardio_report.machine, distance_miles: @cardio_report.distance_miles, duaration_seconds: @cardio_report.duaration_seconds, finished_at: @cardio_report.finished_at } }
    end
  ...
  test "should update cardio_report" do
    patch cardio_report_url(@cardio_report), params: { cardio_report: { cardio_type: @cardio_report.cardio_type, machine: @cardio_report.machine, distance_miles: @cardio_report.distance_miles, duaration_seconds: @cardio_report.duaration_seconds, finished_at: @cardio_report.finished_at } }
